...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="57">
    <nav class="navbar navbar-light navbar-expand-sm fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand" href="#page-top">LF SPORT</a><button data-bs-toggle="collapse" data-bs-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-align-justify"></i></button>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col text-center"><a class="btn btn-primary btn-xl m-2" role="button" href="#about">SOLICITAR SERVIÇO</a></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col text-center"><a class="btn btn-primary btn-xl m-2" role="button" href="#services">SOLICITAR SERVIÇO</a></div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="row">
                ...
                <div class="container">
                    <section class="contact-clean mt-5 mb-5">
                        <form method="post">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" name="assunto" placeholder="Assunto"></div>
                            ...
                            <div class="text-center mb-3"><button class="btn btn-primary btn-lg" type="submit">SOLICITAR</button></div>
                        </form>
                    </section>
                </div>
            </div>
